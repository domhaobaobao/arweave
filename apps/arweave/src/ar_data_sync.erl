...
add_chunk_async(
	...
	gen_server:cast(?MODULE, {add_chunk, DataRoot, DataPath, Chunk, Offset, TXSize}).
...
handle_cast({add_chunk, DataRoot, DataPath, Chunk, Offset, TXSize}, State) ->
